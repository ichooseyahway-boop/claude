...
export const frCA: Messages = {
  ...
  app: {
    ...
    overview: {
      title: 'Vos audits',
      intro:
        'Tous les audits commandés par votre organisation, avec leur état actuel et les constats encore ouverts.',
      empty: 'Aucun audit pour l’instant.',
      emptyBody:
        'Dès qu’un audit est acheté et cadré, il apparaît ici avec sa progression et les rapports publiés.',
    },
    project: {
      status: 'État',
      dueDate: 'Date cible',
      noDueDate: 'Non planifié',
      locales: 'Langues testées',
      package: 'Forfait',
      releasedReports: 'Rapports publiés',
      openFindings: 'Constats ouverts',
      criticalOrHigh: 'Critiques ou élevés',
      viewFindings: 'Voir les constats',
      viewLatestReport: 'Voir le dernier rapport',
      noReportYet: 'Aucun rapport n’a encore été publié.',
    },
    findings: {
      title: 'Constats',
      intro:
        'Constats issus des rapports publiés seulement. Un analyste révise et confirme chaque constat avant qu’il n’apparaisse ici.',
      empty: 'Aucun constat n’a été publié pour ce projet.',
      reference: 'Référence',
      severity: 'Gravité',
      dimension: 'Dimension',
      statusLabel: 'État de la correction',
      expected: 'Comportement attendu',
      observed: 'Comportement observé',
      impact: 'Incidence sur la clientèle',
      remediation: 'Correction recommandée',
      verification: 'Comment nous vérifierons la correction',
      confidence: 'Niveau de confiance',
      riskAccepted: 'Risque accepté',
      riskReviewDate: 'Date de révision',
    },
    report: {
      title: 'Rapport',
      version: 'Version',
      score: 'Note globale',
      grade: 'Cote',
      parity: 'Parité bilingue',
      parityQualitative:
        'Présentée qualitativement : moins de dix paires appariées ont été testées, ce qui est insuffisant pour publier un indice.',
      capApplied: 'Plafond de note appliqué',
      incomplete: 'Couverture incomplète',
      incompleteBody:
        'Plus de 20 % des scénarios prévus n’ont pas pu être notés; la cote est donc retenue. La section sur la portée et les limites explique pourquoi.',
      released: 'Publié le',
      correctionReason: 'Motif de cette correction',
      supersededTitle: 'Remplacé',
      supersededBody:
        'Une version corrigée de ce rapport a été publiée. C’est la version corrigée qui fait foi.',
      notFound: 'Ce rapport n’est pas disponible.',
      notFoundBody:
        'Il se peut qu’il n’ait pas encore été publié, ou que le lien ne soit plus à jour.',
      scenariosPlanned: 'Scénarios prévus',
      scenariosCompleted: 'Scénarios réalisés',
      unscorable: 'Scénarios non notables',
    },
    notifications: {
      title: 'Notifications',
  ...
  ops: {
    nav: {
      label: 'Navigation de l’exploitation',
      queue: 'File de livraison',
      releaseQueue: 'File de publication',
      scenarios: 'Bibliothèque de scénarios',
      auditLog: 'Journal d’audit',
      backToPortal: 'Portail client',
    },
    queue: {
      title: 'File de livraison',
      intro:
        'Projets actifs dans toutes les organisations où vous travaillez, les plus urgents d’abord.',
      empty: 'Rien dans la file.',
      organization: 'Organisation',
      project: 'Projet',
      waitingOn: 'En attente de',
      due: 'Échéance',
      run: 'Exécution active',
      noRun: 'Aucune exécution active',
      overdue: 'En retard',
    },
    release: {
      title: 'File de publication',
      intro:
        'Rapports en attente de publication, avec le motif de blocage de chacun. Un rapport ne peut être publié que si toutes les conditions sont remplies.',
      empty: 'Aucun rapport n’est en attente de publication.',
      readyToRelease: 'Prêt à publier',
      blockedBy: 'Bloqué par',
      blockerCount: 'blocage(s)',
      version: 'Version',
    },
    auditLog: {
      title: 'Journal d’audit',
      intro: 'Actions récentes consignées pour cette organisation.',
  ...
  findingStatus: {
    ...
    ready_for_retest: 'Prêt pour le nouveau test',
    resolved: 'Corrigé',
    partially_resolved: 'Partiellement corrigé',
  ...
  projectStatus: {
    ...
    scope_review: 'Révision de la portée',
    scope_declined: 'Portée refusée',
    planning: 'Planification',
    executing: 'Tests en cours',
    analyst_review: 'Révision par l’analyste',
    release_review: 'Révision avant publication',
    released: 'Publié',
    blocked: 'Bloqué',
    closed: 'Fermé',
  },
