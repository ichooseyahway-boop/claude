...
export const enCA = {
  ...
  app: {
    ...
    overview: {
      title: 'Your audits',
      intro:
        'Every audit your organization has commissioned, with its current state and any findings that are still open.',
      empty: 'No audits yet.',
      emptyBody:
        'Once an audit is purchased and scoped, it appears here with its progress and released reports.',
    },
    project: {
      status: 'Status',
      dueDate: 'Target date',
      noDueDate: 'Not scheduled',
      locales: 'Languages tested',
      package: 'Package',
      releasedReports: 'Released reports',
      openFindings: 'Open findings',
      criticalOrHigh: 'Critical or high',
      viewFindings: 'View findings',
      viewLatestReport: 'View the latest report',
      noReportYet: 'No report has been released yet.',
    },
    findings: {
      title: 'Findings',
      intro:
        'Findings from released reports only. An analyst reviews and confirms every finding before it appears here.',
      empty: 'No findings have been released for this project.',
      reference: 'Reference',
      severity: 'Severity',
      dimension: 'Dimension',
      statusLabel: 'Remediation status',
    ...
    report: {
      ...
      score: 'Overall score',
      grade: 'Grade',
      parity: 'Bilingual parity',
      parityQualitative:
        'Reported qualitatively: fewer than ten matched pairs were tested, which is too few for a published index.',
      capApplied: 'Score cap applied',
      incomplete: 'Incomplete coverage',
      incompleteBody:
        'More than 20% of planned scenarios could not be scored, so the grade is withheld. The scope and limitations section explains why.',
      released: 'Released',
      correctionReason: 'Reason for this correction',
      supersededTitle: 'Superseded',
      supersededBody:
        'A corrected version of this report has been issued. The corrected version is the current one.',
      notFound: 'This report is not available.',
      notFoundBody:
        'It may not have been released yet, or the link may be out of date.',
      scenariosPlanned: 'Scenarios planned',
      scenariosCompleted: 'Scenarios completed',
      unscorable: 'Scenarios that could not be scored',
    },
    notifications: {
      title: 'Notifications',
      empty: 'Nothing new.',
  ...
  ops: {
    nav: {
      ...
      auditLog: 'Audit log',
      backToPortal: 'Customer portal',
    },
    queue: {
      title: 'Delivery queue',
      intro:
        'Active projects across every organization you work in, most urgent first.',
    ...
    release: {
      title: 'Release queue',
      intro:
        'Reports awaiting release, with the reason each one is blocked. A report can only be released when every condition is met.',
      empty: 'No reports are awaiting release.',
    ...
    auditLog: {
      title: 'Audit log',
      intro: 'Recent recorded actions for this organization.',
